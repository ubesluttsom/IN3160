...
set_property DRIVE 12 [get_ports dir_synch]
set_property DRIVE 12 [get_ports en_synch]
set_property SLEW SLOW [get_ports c]
set_property SLEW SLOW [get_ports dir_synch]
set_property SLEW SLOW [get_ports en_synch]
set_property SLEW SLOW [get_ports {abcdefg[6]}]
set_property SLEW SLOW [get_ports {abcdefg[5]}]
set_property SLEW SLOW [get_ports {abcdefg[4]}]
set_property SLEW SLOW [get_ports {abcdefg[3]}]
set_property SLEW SLOW [get_ports {abcdefg[2]}]
set_property SLEW SLOW [get_ports {abcdefg[1]}]
set_property SLEW SLOW [get_ports {abcdefg[0]}]
